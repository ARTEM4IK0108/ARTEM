...
img_enemy = "ufo.png" # jordj.png
img_ast = "asteroid.png" # пеппа
...
reload_time = 3 #время перезарядки

def GetBulets(ammo, shotCount):
    bulets = '|' * (ammo - shotCount)
    return bulets

def GetHearths(hearthsCount):
    hearths = ('0 ') * hearthsCount
    return hearths
...
while run:
    ...
    if not finish:
        ...
        if rel_time == True:
            ...
            if now_time - last_time < reload_time: # пока не прошло 3 секунды выводим информацию о перезарядке
        ...
        text_reload = font2.render("num_fire: " + str(GetBulets(15, num_fire)), 1, (255, 255, 255))
        window.blit(text_reload, (10, 80))

        text_lose = font2.render("Пропущено: " + str(lost), 1, (255, 255, 255))
        window.blit(text_lose, (10, 50))

        text_heaths =  font2.render(GetHearths(life), 1, (255, 255, 255))
        window.blit(text_heaths, (10, 110))
        ...
        text_life = font1.render(GetHearths(life), 1, life_color)
